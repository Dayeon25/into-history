...
import { Send, User, Bot, Loader2, RefreshCcw, Save, Edit2, Trash2, Check, X } from 'lucide-react';
        ...
        <div className="relative z-10 space-y-6">
            ...
            {messages.map((msg, i) => (
              ...
              >
                <div className={cn(
                  ...
                  msg.role === 'user' ? "bg-accent text-white" : "bg-white border border-accent/20 text-accent"
                )}>
          ...
          {isLoading && (
            <div className="flex gap-4">
              <div className="w-8 h-8 rounded-full bg-white border border-accent/20 text-accent flex items-center justify-center">
